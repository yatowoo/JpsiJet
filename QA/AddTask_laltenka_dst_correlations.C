//===============================================================================================================
// addtask to create trees for J/psi - hadron correlation analysis in pp 13TeV (last updated: 20/03/2018)
//===============================================================================================================
...
AliAnalysisTask *AddTask_laltenka_dst_correlations(Int_t reducedEventType=-1, Bool_t writeTree=kTRUE, TString  prod="") {
    ...
    else { printf("WARNING: In AddTask_laltenka_dst(), no trigger specified, or not supported! Using kINT7.\n"); task->SetTriggerMask(AliVEvent::kINT7); }
    ...
    task->AddTrackFilter(AssociatedHadronFilter(isAOD),   kTRUE);   // base track info, fQualityFlag bit 33 - unid. hadron
    task->AddTrackFilter(AssociatedHadronFilter2(isAOD),  kTRUE);   // base track info, fQualityFlag bit 34 - unid. hadron + no ITS refit
    task->AddTrackFilter(AssociatedHadronFilter3(isAOD),  kTRUE);   // base track info, fQualityFlag bit 35 - unid. hadron + SPD any
    task->AddTrackFilter(AssociatedHadronFilter4(isAOD),  kTRUE);   // base track info, fQualityFlag bit 36 - unid. hadron + no kinks
    task->AddTrackFilter(AssociatedHadronFilter5(isAOD),  kTRUE);   // base track info, fQualityFlag bit 37 - unid. hadron + SPD any + no kinks
    ...
    //task->SetWriteEventsWithNoSelectedTracks(kFALSE, 0.02, 2);
...
//_______________________________________________________________________________________________________________
AliAnalysisCuts* AssociatedHadronFilter3(Bool_t isAOD) {
  AliDielectronCutGroup* assocHadr = new AliDielectronCutGroup("assocHadr","Associated hadrons, SPD any",AliDielectronCutGroup::kCompAND);
  AliDielectronVarCuts *trackCuts3 = new AliDielectronVarCuts("trackCuts3","track cuts3");
  trackCuts3->AddCut(AliDielectronVarManager::kImpactParXY,-1.0,1.0);
  trackCuts3->AddCut(AliDielectronVarManager::kImpactParZ,-3.0,3.0);
  trackCuts3->AddCut(AliDielectronVarManager::kEta,-0.9,0.9);
...
//_______________________________________________________________________________________________________________
AliAnalysisCuts* AssociatedHadronFilter4(Bool_t isAOD) {
  AliDielectronCutGroup* assocHadr = new AliDielectronCutGroup("assocHadr","Associated hadrons, no kinks",AliDielectronCutGroup::kCompAND);
  AliDielectronVarCuts *trackCuts3 = new AliDielectronVarCuts("trackCuts3","track cuts3");
  trackCuts3->AddCut(AliDielectronVarManager::kImpactParXY,-1.0,1.0);
  trackCuts3->AddCut(AliDielectronVarManager::kImpactParZ,-3.0,3.0);
  trackCuts3->AddCut(AliDielectronVarManager::kEta,-0.9,0.9);
...
//_______________________________________________________________________________________________________________
AliAnalysisCuts* AssociatedHadronFilter5(Bool_t isAOD) {
  AliDielectronCutGroup* assocHadr = new AliDielectronCutGroup("assocHadr","Associated hadrons, SPD any + no kinks",AliDielectronCutGroup::kCompAND);
  AliDielectronVarCuts *trackCuts3 = new AliDielectronVarCuts("trackCuts3","track cuts3");
  trackCuts3->AddCut(AliDielectronVarManager::kImpactParXY,-1.0,1.0);
  trackCuts3->AddCut(AliDielectronVarManager::kImpactParZ,-3.0,3.0);
  trackCuts3->AddCut(AliDielectronVarManager::kEta,-0.9,0.9);
