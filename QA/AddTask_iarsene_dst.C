...
void AddFMDTask(){
  ...
  AliAnalysisTaskESDfilter *esdfilter = reinterpret_cast<AliAnalysisTaskESDfilter*>(gInterpreter->ExecuteMacro("$ALICE_ROOT/ANALYSIS/ESDfilter/macros/AddTaskESDFilter.C(kTRUE, kFALSE, kFALSE, kFALSE, kFALSE, kTRUE)"));
  ...
  AliAnalysisTask *taskFmd  = reinterpret_cast<AliAnalysisTask*>(gInterpreter->ExecuteMacro(Form("AddTaskForwardMult.C(%d,%d,%d,%d,%d,\"%s\")",mc, run, sys, sNN, fld, config)));
